...
// AcDbObjectIdArray, of objects of type "CrxDbObjectId".
//
// "Dynamic array" means that the array can grow without bounds,
// unlike declaring an array of objects of type "CrxDbObjectId" in the
// usual manner.  For example declaring "CrxDbObjectId myArray[10]"
...
#endif
#include "crxArray.h"
typedef CRxArray<CRxDbObjectId> CRxDbObjectIdArray;
#endif
