#ifndef CRX_DBINTAR_H
#define CRX_DBINTAR_H
//
...
// CRxDbIntArray, of objects of type "int".
//
...
//
// In order to use the class CRxDbIntArray, you need to understand
...
#include "crxArray.h"
typedef CRxArray<int> CRxDbIntArray;
typedef CRxArray<CAXA::IntPtr> CRxDbIntPtrArray;
#endif
