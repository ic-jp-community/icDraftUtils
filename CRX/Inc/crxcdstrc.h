...
struct CDraft
{
	enum ErrorStatus       { 
		...
		eInetNoAcadInet,       // Could not locate CDRAFTINET.DLL on the system
		...
		// CRxDbCustomOsnapManager specific
		eAlreadyActive,
		eAlreadyInactive,
		// End CRxDbCustomOsnapManager specific
	...
	enum PaperSizeDescription{
		ePaperSizeA0 = 6000,
		ePaperSizeA1 = 6010,
		ePaperSizeA2 = 6020,
		ePaperSizeA3 = 6030,
		ePaperSizeA4 = 6040,
		ePaperSizeCustom = 6050
	};
