...
#define RQCFG   22 /* CaxaDraft is returning from CONFIG */
...
/*  ADS program to CaxaDraft result type codes 
 */
...
/* Various error codes returned to CDS application by library
 */
#define RTERROR          (-5001) // Some other error
#define RTCAN            (-5002) // User cancelled request -- Ctl-C
#define RTREJ            (-5003) // CDraft rejected request -- invalid
...
#ifndef WM_USER
#define WM_CDRAFT_KEEPFOCUS (0x0400+0x6D01)
#else
